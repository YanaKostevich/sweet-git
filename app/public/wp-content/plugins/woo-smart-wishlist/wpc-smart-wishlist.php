...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '4.6.2' );
		...
		if ( ! class_exists( 'WPCleverWoosw' ) ) {
			class WPCleverWoosw {
				...
				function __construct() {
					...
					add_action( 'before_woocommerce_init', function () {
						if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
							\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', WOOSW_FILE );
						}
					} );
				}
				...
				function wpcsm_locations( $locations ) {
					$locations['WPC Smart Wishlist'] = array(
