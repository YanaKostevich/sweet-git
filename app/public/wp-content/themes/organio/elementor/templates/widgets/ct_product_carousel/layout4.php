...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-product-carousel4 ct-dots-style2 ct-slick-slider ct-arrow-middle woocommerce" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
