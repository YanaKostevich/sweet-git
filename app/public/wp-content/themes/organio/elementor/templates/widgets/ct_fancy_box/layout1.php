...
?>
<div class="ct-fancy-box ct-fancy-box-layout1 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    <div class="item--inner bg-image">
        ...
        <div class="item--description"><?php echo ct_print_html($settings['description_text']); ?></div>
    </div>
</div>