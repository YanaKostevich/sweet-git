...
<div class="ct-menu-item-wrap <?php echo esc_attr($col.' '.$style); ?>">
    <?php if(!empty($wg_title)) : ?>
        <div class="ct-wg-title">
            <span class="ct-icon-menu-lg"><i></i></span>
                ...
                <li>
                    <a <?php echo implode( ' ', [ $link_attributes ] ); ?>>
                        <?php if ( $has_icon ) : ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <span><?php echo ct_print_html($item['text']); ?></span>
