...
if(class_exists('Woocommerce')) {
    ...
    $show_quantity = $widget->get_setting('show_quantity', 'no');
    ...
    $load_more = array(
        ...
        'template_type' => 'product_grid_layout3',
    );
    ?>

    <div id="<?php echo esc_attr($html_id) ?>" class="ct-grid ct-product-grid ct-product-grid-layout3 woocommerce" data-layout="<?php echo esc_attr($layout_type); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
