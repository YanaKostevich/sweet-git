...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-portfolio-carousel1 ct-slick-slider ct-arrow-middle" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
