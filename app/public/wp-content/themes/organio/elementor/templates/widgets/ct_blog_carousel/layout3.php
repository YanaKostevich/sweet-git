...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout3 ct-slick-slider ct-dots-style3" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
                    ...
                    <div class="item--holder">
                        ...
                        <?php if($show_button == 'true') : ?>
                            <div class="item--readmore">
                                <a class="btn btn-primary-dot" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
