...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout7 ct-slick-slider ct-dots-<?php echo esc_attr($settings['dot_style']) ?>" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
