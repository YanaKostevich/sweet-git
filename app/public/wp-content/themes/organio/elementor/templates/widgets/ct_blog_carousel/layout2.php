...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel-layout2 ct-slick-slider" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
