...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-product-carousel3 woocommerce-product-meta-grid ct-slick-slider ct-arrow-middle woocommerce" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
