...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-product-carousel10 woocommerce-product-meta-grid ct-slick-slider ct-arrow-middle woocommerce <?php echo esc_attr($settings['style']); ?>" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
