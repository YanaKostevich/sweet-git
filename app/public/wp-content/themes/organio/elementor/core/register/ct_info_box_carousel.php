...
// Register Info Box Widget
ct_add_custom_widget(
    array(
        'name' => 'ct_info_box_carousel',
        'title' => esc_html__('Case Info Box Slider', 'organio'),
        'icon' => 'eicon-info-box',
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'first_letter',
                                    'label' => esc_html__('First Letter', 'organio'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'description',
                                ...
                                array(
                                    'name' => 'main_color',
                                    'label' => esc_html__('Main Color', 'organio' ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .ct-infobox .item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-infobox .item--title',
                        ),
                        array(
                            'name' => 'ct_animate_t',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .ct-infobox .item--description' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .ct-infobox .item--description',
                        ),
                        array(
                            'name' => 'ct_animate_d',
                            'label' => esc_html__('Case Animate', 'organio' ),
