...
<header id="ct-masthead">
    <div id="ct-header-wrap" class="ct-header-layout9 <?php if($sticky_on == 1) { echo 'is-sticky '; echo esc_attr($sticky_header_type); } ?>" data-offset-sticky="140">
        <div id="ct-header-middle" class="ct-hidden-lg">
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <?php if ( has_nav_menu( 'menu-shop' ) ) { ?>
                        <div class="ct-menu-shop ct-hidden-lg">
                            <?php $attr_menu = array(
                    ...
                    <?php } ?>
                    <div class="ct-header-branding ct-hidden-xl">
                        <div class="ct-header-branding-inner">
                            <?php get_template_part( 'template-parts/header-branding' ); ?>
                        </div>
                    </div>
